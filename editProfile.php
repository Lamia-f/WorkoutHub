        ...
        <section class="appointment">
            <div class="container">
                <div class="appointment__text">
                    ...
                    <form action="updateProfile.php" method="post" class="appointment__form">
                        <?php if (isset($_GET['outName'])) {
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 text-center">
                                <input type="password" name="password" placeholder="Password" value="<?= $_SESSION['password']; ?>"><br /><br />
                                <button type="submit" name="saveupdate"> Save </button> <a href="profile.php"><button type="button">Cancel</button></a>
